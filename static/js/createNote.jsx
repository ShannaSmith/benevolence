...
function CreateNote(props){
    ...
    <>
        ...
        <textarea className="form-control text-box" placeholder="Enter your plan" type="textarea" rows="3" name="note" value={noteText} onChange={(evt) =>{setNoteText(evt.target.value)}}></textarea>
